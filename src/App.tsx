  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden text-neutral-100" style={{ background: '#141414' }}>
      <div className="relative flex flex-1 overflow-hidden">
        ...
        <aside className="absolute left-4 top-1/2 z-10 hidden -translate-y-1/2 flex-col items-center gap-2 rounded-2xl border border-white/[0.06] px-2 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.8)] backdrop-blur-md lg:flex" style={{ background: 'rgba(0, 0, 0, 0.6)' }}>
          {/* GitHub */}
          ...
          {nodes.map((node) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex h-10 w-10 items-center justify-center rounded-lg text-white transition-all duration-200 hover:bg-white/[0.08]',
        ...
        {/* Right Inspector Panel - Only shows when node is selected */}
        {selectedNodeId && (
          <aside className="hidden h-full w-[340px] shrink-0 flex-col border-l border-white/[0.06] bg-[rgb(10,13,18)] lg:flex">
